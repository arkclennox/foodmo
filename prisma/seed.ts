  ...
  const cities: Array<{ slug: string; name: string; province: string; description: string }> = [
    {
      ...
      description:
        'Ibukota dengan ragam kuliner dari warteg, warung legendaris, hingga fine dining.',
    },
    {
      slug: 'bandung',
      name: 'Bandung',
      province: 'Jawa Barat',
      description:
        'Surga kuliner dengan cafe aesthetic, batagor, surabi, dan nasi timbel khas Sunda.',
    },
    {
      slug: 'surabaya',
      name: 'Surabaya',
      province: 'Jawa Timur',
      description: 'Kota pahlawan dengan rawon, rujak cingur, dan lontong balap.',
    },
    {
      slug: 'yogyakarta',
      name: 'Yogyakarta',
      province: 'DI Yogyakarta',
      description: 'Kota pelajar dengan gudeg, angkringan, dan kedai kopi legendaris.',
    },
    {
      slug: 'malang',
      name: 'Malang',
      province: 'Jawa Timur',
      description: 'Kota dingin dengan bakso, cwie mie, dan cafe pegunungan.',
    },
    {
      slug: 'bali',
      name: 'Bali',
      province: 'Bali',
      description: 'Destinasi wisata dengan babi guling, nasi campur Bali, dan cafe tepi pantai.',
    },
    {
      slug: 'semarang',
      name: 'Semarang',
      province: 'Jawa Tengah',
      description: 'Kota Lumpia dengan tahu gimbal, lunpia, dan soto.',
    },
    {
      slug: 'medan',
      name: 'Medan',
      province: 'Sumatera Utara',
      description: 'Kuliner Melayu-Tionghoa: bihun bebek, soto medan, kopi tiam.',
    },
  ];
